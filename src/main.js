...
function moreView(){
  return '<section class="v19-more-page" data-v19-more>'+
    ...
    '<div class="v19-more-menu">'+
      ...
      v19MoreButton('history','Historial','history')+

...
function quizArenaView(){
  return `<section class="v48-quiz-arena-page" data-v48-real-ui aria-label="Quiz Arena">
    <header class="v48-arena-hero">
      <span class="v48-arena-swoosh v48-swoosh-a" aria-hidden="true"></span>
      <span class="v48-arena-swoosh v48-swoosh-b" aria-hidden="true"></span>
      <button type="button" class="v48-arena-back" data-route="more" aria-label="Volver">
        <svg viewBox="0 0 32 32" aria-hidden="true"><path d="M21 6 11 16l10 10M12 16h15"/></svg>
      </button>
      <h1>Quiz Arena</h1>
    </header>

    <article class="v48-arena-card">
      <div class="v48-arena-ball" aria-hidden="true">
        <svg viewBox="0 0 420 360" role="presentation">
          <defs>
            <radialGradient id="v48BallFill" cx="50%" cy="32%" r="75%">
              <stop offset="0%" stop-color="#184cff"/>
              <stop offset="54%" stop-color="#0826c0"/>
              <stop offset="100%" stop-color="#04116f"/>
            </radialGradient>
            <linearGradient id="v48Seam" x1="0" x2="1">
              <stop offset="0%" stop-color="#1ee8ff"/>
              <stop offset="33%" stop-color="#ff3eb6"/>
              <stop offset="66%" stop-color="#a6ef45"/>
              <stop offset="100%" stop-color="#25caff"/>
            </linearGradient>
            <filter id="v48Glow"><feGaussianBlur stdDeviation="3" result="b"/><feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge></filter>
            <clipPath id="v48BallClip"><circle cx="210" cy="210" r="190"/></clipPath>
          </defs>
          <circle cx="210" cy="210" r="190" fill="url(#v48BallFill)"/>
          <g clip-path="url(#v48BallClip)" fill="none" stroke="url(#v48Seam)" stroke-width="2.3" filter="url(#v48Glow)" opacity=".9">
            <path d="M16 133 95 72l83 12 50 66-38 75-94 24-80-42"/>
            <path d="M178 84 260 43l92 39 48 72-63 70-93-18-16-56"/>
            <path d="M95 72 65 3M260 43 287-15M352 82 430 49"/>
            <path d="M190 225 244 206l79 58-24 88-101 28-72-61z"/>
            <path d="M96 249 126 319l-72 60-75-54 13-94z"/>
            <path d="M337 224 406 202l56 68-29 90-88-8-46-88z"/>
            <path d="M126 319 198 380 299 352M54 379 198 380M299 352 433 360"/>
            <path d="M24 133 76 162l20 87M228 150 292 134l45 90"/>
          </g>
          <circle cx="210" cy="210" r="190" fill="none" stroke="rgba(255,255,255,.18)" stroke-width="2"/>
        </svg>
      </div>
      <div class="v48-arena-actions">
        <button type="button" class="v48-arena-btn primary" data-route="quiz">Inicia sesión para jugar</button>
        <button type="button" class="v48-arena-btn outline" data-route="quiz">Prueba como invitado</button>
      </div>
    </article>

    <div class="v48-arena-promo" aria-label="Liga Municipal de Fútbol Juventino Rosas">
      <span class="v48-promo-mark">JR</span>
      <span><b>Liga Municipal de Fútbol</b><small>Juventino Rosas · Quiz oficial</small></span>
    </div>

    <section class="v48-friends-card">
      <div class="v48-friends-copy">
        <h2>¡Reta a tus amigos en el Quiz!</h2>
        <p>Compite por demostrar quién sabe más de la Liga.</p>
        <button type="button" data-route="quiz">Jugar ahora</button>
      </div>
      <div class="v48-friends-art" aria-hidden="true">
        <span class="v48-friend one"></span>
        <span class="v48-friend two"></span>
      </div>
    </section>
  </section>`;
}

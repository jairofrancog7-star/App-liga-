import {LEAGUE_LOGO,LEAGUE_LOGO_WHITE,TEAM} from './data.js';
...
export const leagueLogoWhite=(cl='')=>`<img class="v11-league-logo v11-league-logo-white ${cl}" src="${LEAGUE_LOGO_WHITE}" alt="Liga Municipal de Fútbol Juventino Rosas">`;

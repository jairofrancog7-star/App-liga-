const V11 = {
  league:'./public/teams/league.webp',
  teams:[
    {id:'america',code:'AMV',name:'Club América Veteranos J. Rosas',logo:'./public/teams/america.webp',pts:19,pj:8,gd:11},
    {id:'lobos',code:'LOB',name:'Lobos CDG',logo:'./public/teams/lobos.webp',pts:17,pj:8,gd:8},
    {id:'huerta',code:'HUE',name:'La Huerta de Cuenda',logo:'./public/teams/huerta.webp',pts:16,pj:8,gd:5},
    {id:'galeana',code:'ATG',name:'Atlético Galeana',logo:'./public/teams/galeana.webp',pts:14,pj:8,gd:2},
    {id:'promesas',code:'PRO',name:'Promesas FC Pozos',logo:'./public/teams/promesas.webp',pts:13,pj:8,gd:1},
    {id:'franco',code:'FCO',name:'Franco FC',logo:'./public/teams/franco.webp',pts:11,pj:8,gd:-1},
    {id:'sanantonio',code:'SAN',name:'San Antonio',logo:'./public/teams/sanantonio.webp',pts:9,pj:8,gd:-3},
    {id:'esperanza',code:'ESP',name:'La Esperanza',logo:'./public/teams/esperanza.webp',pts:8,pj:8,gd:-4},
    {id:'juventino',code:'JUV',name:'Deportivo Juventino Rosas',logo:'./public/teams/league.webp',pts:7,pj:8,gd:-5},
  ],
  players:[

...
const historyMoments=[
  ...
  {kind:'SUBCAMPEÓN',date:'07 jun 2026',season:'2025–2026',title:'Aldama FC',subtitle:'Subcampeón · Segunda Fuerza',detail:'Aldama FC quedó en segundo lugar en la final de Segunda Fuerza frente a La Canchita Deportes.',backgroundPhoto:'./assets/history/archive-v304/aldama-fc-subcampeon-segunda-07-jun-2026.webp?v=20260923-aldama-photo-v304',image:HIST_ROOT+'assets/official-logos/aldama-fc.png'},
  ...
  {kind:'SUBCAMPEÓN',date:'20 dic 2025',season:'2025–2026',title:'Juventus',subtitle:'Subcampeón · Torneo de Copa',detail:'Juventus quedó como subcampeón de la final de Copa frente a Salvajes el 20 de diciembre de 2025.',backgroundPhoto:'./assets/history/archive-v310/juventus-subcampeon-copa-20-dic-2025.webp?v=20260923-juventus-sub-photo-v310',image:HIST_ROOT+'assets/official-logos/juventus.png'},
  ...
  {kind:'SUBCAMPEÓN',date:'20 sep 2025',season:'2025',title:'Salvajes',subtitle:'Subcampeón · Veteranos 35 y más',detail:'Salvajes quedó como subcampeón de Liga de Veteranos 35 y más frente a Juventus el 20 de septiembre de 2025.',backgroundPhoto:'./assets/history/archive-v305/salvajes-subcampeon-veteranos35-20-sep-2025.webp?v=20260923-salvajes-fixed-v307'},
  {kind:'CAMPEÓN',date:'29 jun 2025',season:'2025',winner:'La Huerta de Cuenda',title:'La Huerta de Cuenda',subtitle:'Campeón de Liga · Segunda Fuerza',detail:'Dato e imagen aportados por el usuario: La Huerta de Cuenda ganó la final de Segunda Fuerza frente a Tavera FC el 29 de junio de 2025. Se usa la fotografía real del equipo campeón con el trofeo.',backgroundPhoto:'./assets/history/archive-v203/la-huerta-cuenda-campeon-segunda-29-jun-2025.jpg?v=20260924-preserve-bg-v323'},
  {kind:'SUBCAMPEÓN',date:'29 jun 2025',season:'2025',title:'Tavera FC',subtitle:'Subcampeón · Segunda Fuerza',detail:'Tavera FC quedó como subcampeón de Segunda Fuerza frente a La Huerta de Cuenda el 29 de junio de 2025.',backgroundPhoto:'./assets/history/archive-v119/tavera-finalista-2025.jpg?v=20260924-preserve-bg-v323',image:HIST_ROOT+'assets/official-logos/tavera-fc.png'},
  ...
  {kind:'TERCER LUGAR',date:'03 nov 2019',season:'2018–2019',title:'Abejas',subtitle:'Tercer lugar · Primera Fuerza · 2018–2019',detail:'Publicación aportada por el usuario: el equipo Abejas obtuvo el tercer lugar de la temporada 2018–2019 en Primera Fuerza.',backgroundPhoto:'./assets/history/archive-v315/abejas-tercer-lugar-03-nov-2019.webp?v=20260924-abejas-file-v316',image:HIST_ROOT+'assets/official-logos/abejas.png',championsOnly:true},
...
{kind:'CAMPEÓN',date:'11 dic 2012',season:'2012',winner:'Tavera FC',title:'Tavera FC',subtitle:'Campeón de Copa · Categoría Segunda',detail:'Golazo Liga felicitó al equipo Tavera como campeón de Copa de la Categoría Segunda el 11 de diciembre de 2012.',backgroundPhoto:'./assets/history/archive-v260/tavera-campeon-copa-segunda-11-dic-2012.webp?v=20260923-old-history-v260',image:HIST_ROOT+'assets/official-logos/tavera-fc.png'},
  ...
  {kind:'PENALES',date:'23 feb 2013',title:'Magisterio 4–2 Boavista',subtitle:'0–0 en tiempo reglamentario · tanda de penales',detail:'Golazo Liga registró empate 0–0 en tiempo reglamentario y victoria de Magisterio 4–2 en la tanda de penales.',historyBottom:true},
...
const verifiedChampions=[
  ...
  {season:'11 ene 2015',competition:'Primera Fuerza',champion:'Boavista',runner:'—',source:'Dato e imagen aportados por el usuario: Boavista fue campeón de Primera Fuerza el 11 de enero de 2015. La fotografía muestra al plantel campeón con el trofeo.',photo:'./assets/history/archive-v316/boavista-campeon-primera-11-ene-2015.webp?v=20260923-boavista-real-v316',championLogo:HIST_ROOT+'assets/official-logos/boavista.png'},
  ...
  {season:'14 abr 2015',competition:'Campeón de Copa',champion:'Juventus',runner:'—',source:'Publicación de Facebook aportada por el usuario, fechada el 14 de abril de 2015, con el texto “Los campeones de copa”. El equipo campeón es Juventus.',photo:'./assets/history/archive-v279/campeones-copa-14-abr-2015.jpg?v=20260923-juventus-copa-14abr2015-v294',championLogo:HIST_ROOT+'assets/official-logos/juventus.png'},
...
function historyMomentCard(m){
  ...
  return '<article class="v35-history-moment '+(hasBg?'v35-history-moment-photo ':'')+((hasBg&&!bgExact)?'v35-history-moment-reference':'')+esperanzaBgClass+manchester2024BgClass+psv2019BgClass+abejas2014Class+abejas2019BgClass+'">'+
...
function historyMomentCards(){
  const visible=historyMoments.filter(m=>!m.archiveOnly);
  const featured=historyNewestFirst(visible.filter(m=>!m.historyBottom),'date');
  const bottom=historyNewestFirst(visible.filter(m=>m.historyBottom),'date');
  return '<div class="v35-history-moments">'+featured.concat(bottom).map(historyMomentCard).join('')+'</div>';
}

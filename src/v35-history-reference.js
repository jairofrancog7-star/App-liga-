...
function v231ManchesterCopaCard(m){
  const photo='./assets/history/archive-v231/manchester-veteranos50-copa-09-nov-2024-hq.webp?v=20260923-manchester-hq-v231';
  return '<article class="v35-history-moment v35-history-moment-photo v231-manchester-copa" data-v231-manchester-copa>'+
    '<img class="v35-history-bg-photo v35-bg-exact" src="'+photo+'" alt="" aria-hidden="true" loading="eager" decoding="async" style="filter:none!important;image-rendering:auto!important;object-fit:cover!important;object-position:center 48%!important;transform:none!important;">'+
    '<div class="v35-history-moment-shade" aria-hidden="true" style="display:block!important;background:linear-gradient(180deg,rgba(3,6,50,.08) 0%,rgba(3,6,50,.22) 34%,rgba(3,6,50,.80) 72%,rgba(3,6,50,.96) 100%),linear-gradient(90deg,rgba(3,6,50,.62),rgba(3,6,50,.08));"></div>'+
    '<div class="v35-history-moment-content" style="position:relative!important;z-index:5!important;width:100%!important;">'+
      ...
      '<div class="v35-history-status">'+
        ...
        '<span><b>Temporada</b>'+esc(m.season||'2024')+'</span>'+
      '</div>'+
      '<p>'+esc(m.detail)+'</p>'+
    '</div>'+
  '</article>';
}
function v231IsManchesterCopa(m){
  const n=v=>String(v||'').normalize('NFD').replace(/[\u0300-\u036f]/g,'').toLowerCase();
  return n(m?.title)==='manchester' && n(m?.date).includes('09 nov 2024');
}
...
function v227GalacticosChampionCard(m){
  /* V234 — HARD RENDER DIRECTO.
     La fotografía queda embebida en esta misma función y el cuadro NO usa
     las clases genéricas que luego modifican los parches históricos. */
  ...
  return '<article data-v234-galacticos="1" style="position:relative;isolation:isolate;overflow:hidden;width:100%;min-height:430px;display:flex;align-items:flex-end;margin:0;padding:0;border:1px solid rgba(77,224,241,.34);border-radius:22px;background-color:#060653;box-shadow:0 12px 28px rgba(0,0,55,.18),inset 0 1px 0 rgba(255,255,255,.05)">'+
    '<img src="'+photo+'" alt="" aria-hidden="true" style="position:absolute;inset:0;z-index:0;width:100%;height:100%;display:block;object-fit:cover;object-position:center 48%;margin:0;padding:0;border:0;opacity:1;filter:saturate(1.06) contrast(1.03) brightness(.96)">'+
    '<span aria-hidden="true" style="position:absolute;inset:0;z-index:1;pointer-events:none;background:linear-gradient(180deg,rgba(2,5,45,.03) 0%,rgba(2,5,45,.08) 28%,rgba(2,5,45,.34) 63%,rgba(2,5,45,.84) 100%),linear-gradient(90deg,rgba(2,5,45,.22) 0%,rgba(2,5,45,.04) 70%,rgba(2,5,45,0) 100%)"></span>'+
    '<div style="position:relative;z-index:2;width:100%;padding:20px 18px 19px;background:transparent;color:#fff">'+
      '<div style="display:flex;align-items:center;flex-wrap:wrap;gap:8px;margin:0 0 11px">'+
        '<span style="display:inline-flex;align-items:center;min-height:27px;padding:0 10px;border:1px solid rgba(38,237,246,.58);border-radius:999px;color:#26edf6;background:rgba(2,7,61,.42);font-size:10px;line-height:1;font-weight:900;letter-spacing:.08em">CAMPEÓN</span>'+
        '<time style="display:inline-flex;align-items:center;min-height:27px;padding:0 10px;border:1px solid rgba(255,255,255,.24);border-radius:999px;color:#fff;background:rgba(2,7,61,.48);font-size:10px;line-height:1;font-weight:850">09 feb 2025</time>'+
      '</div>'+
      '<h3 style="margin:0;color:#fff;font-size:clamp(29px,7.8vw,40px);line-height:1.02;font-weight:800;letter-spacing:-.035em;text-shadow:0 2px 12px rgba(0,0,0,.78)">Galácticos de Pozos</h3>'+
      '<strong style="display:block;margin-top:7px;color:#fff;font-size:clamp(14px,3.8vw,18px);line-height:1.2;font-weight:760;text-shadow:0 2px 9px rgba(0,0,0,.76)">Campeón de Campeones · Primera Fuerza</strong>'+
      '<div style="display:grid;grid-template-columns:1fr 1fr;gap:9px;margin:13px 0 11px">'+
        '<span style="min-width:0;padding:10px 11px;border:1px solid rgba(55,231,242,.56);border-radius:13px;background:rgba(3,8,58,.18);color:#fff;font-size:10px;line-height:1.25;font-weight:760;text-shadow:0 2px 8px rgba(0,0,0,.76)"><b style="display:block;margin-bottom:4px;color:#26edf6;font-size:7.7px;line-height:1;letter-spacing:.09em;text-transform:uppercase">Ganador</b>Galácticos de Pozos</span>'+
        '<span style="min-width:0;padding:10px 11px;border:1px solid rgba(55,231,242,.56);border-radius:13px;background:rgba(3,8,58,.18);color:#fff;font-size:10px;line-height:1.25;font-weight:760;text-shadow:0 2px 8px rgba(0,0,0,.76)"><b style="display:block;margin-bottom:4px;color:#26edf6;font-size:7.7px;line-height:1;letter-spacing:.09em;text-transform:uppercase">Temporada</b>2025</span>'+
      '</div>'+
      '<p style="margin:0;color:#f2f4ff;font-size:clamp(12px,3.3vw,15px);line-height:1.42;text-shadow:0 2px 9px rgba(0,0,0,.84)">La Liga Municipal de Fútbol “JUVENTINO ROSAS” A.C. felicitó al equipo GALÁCTICOS de Pozos por haber obtenido el cetro de Campeón de Campeones, al imponerse al equipo LINCES el 9 de febrero de 2025.</p>'+
    '</div>'+
  '</article>';
}
...
function historyMomentCard(m){
  if(v231IsManchesterCopa(m)) return v231ManchesterCopaCard(m);

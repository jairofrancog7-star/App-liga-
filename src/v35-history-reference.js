...
const historicalTeamEras=[
  ...
  {period:'2026 · temporada actual documentada',category:'Cinco categorías de la Liga',teams:[
    'C. de Gasca','Juventus','Cuenda','Pozos FC','Boavista','PSV','A. Santiago','F. Tavera','América','Huracán',
    ...
    'La Canchita Deportes','Galeana','Aldama FC','Malvinas','Capibaras','La Cuadrilla','Mazacotes FC','Dep. Maravillas','Osasuna','San Antonio JRS','Populares','Promesas','La Huerta',
...
function refereeTravelBlock(){
  return '<section class="v35-history-format v35-referee-travel">'+
    ...
    '<div class="v35-result-list v35-video-findings">'+refereeTravelAllowances.map(x=>'<article class="v35-final-row"><span>VIÁTICO</span><b>'+esc(x.place)+'</b><strong>
...
})();+esc(x.fee.toFixed(2))+'</strong></article>').join('')+'</div>'+

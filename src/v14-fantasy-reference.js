...
function v15Markup(){
  return '<section class="v15-fantasy-master" data-v15-fantasy>'+
    ...
    '<div class="v15-neon" aria-hidden="true"><i></i><i></i><i></i><i></i><i></i><i></i><i></i><i></i></div>'+
    '<div class="v15-copy">'+
      '<h1>FANTASY</h1>'+
      '<div class="v15-league"><strong>LIGA MUNICIPAL DE FÚTBOL</strong><strong>JUVENTINO ROSAS</strong><span>GUANAJUATO</span></div>'+
    '</div>'+

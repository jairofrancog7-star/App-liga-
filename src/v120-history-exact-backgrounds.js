...
const EXACT=[
  ...
  {need:['salvajes','20 sep 2025'],src:'./assets/history/archive-v305/salvajes-subcampeon-veteranos35-20-sep-2025.webp?v=20260923-salvajes-real-v306',pos:'center 45%',photoOnly:true,scale:1.0,origin:'center 45%'},

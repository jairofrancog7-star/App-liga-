...
const EXACT=[
  ...
  {need:['galacticos','09 feb 2025'],src:'./assets/history/archive-v203/galacticos-campeon-campeones-09-feb-2025.jpg?v=20260923-galacticos-real-v243',pos:'center 48%',photoOnly:true,scale:1.00,origin:'center 48%'},
...
function forceGalacticosCDC(){
  const wanted='./assets/history/archive-v203/galacticos-campeon-campeones-09-feb-2025.jpg?v=20260923-galacticos-real-v243';
  document.querySelectorAll('.v35-history-moment,.v35-champion-card,.v115-card').forEach(card=>{
    ...
    // V243 — la foto aportada por el usuario debe verse aunque un <img> viejo haya fallado/caché.
    img.onerror=()=>{
      img.onerror=null;
      img.src='https://raw.githubusercontent.com/jairofrancog7-star/App-liga-/main/assets/history/archive-v203/galacticos-campeon-campeones-09-feb-2025.jpg?v=20260923-galacticos-real-v243';
    };
    const cssWanted='https://jairofrancog7-star.github.io/App-liga-/assets/history/archive-v203/galacticos-campeon-campeones-09-feb-2025.jpg?v=20260923-galacticos-real-v243';
